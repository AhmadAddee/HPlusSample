...
public class ApplicationDao {
	...
	public int registerUser(User user) {
		...
		try {
			...
			String insertQuery = "insert into hplus.users values(?,?,?,?,?,?)";
	...
	public boolean validateUser(String username, String password) {
		...
		try {
			...
			String sql = "select * from hplus.users where username=? and password=?";
	...
	public User getProfileDetails(String username) {
		...
		try {
			...
			String sql = "select * from hplus.users where username=?";
	...
	public List<Order> getOrders(String username) {
		...
		try {
			...
			String sql = "select * from hplus.orders where user_name=?";
			PreparedStatement statement = connection.prepareStatement(sql);
			statement.setString(1, username);
